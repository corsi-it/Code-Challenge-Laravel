...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $report['first_half_revenue'] }}</td>
                    <td>{{ $report['second_half_revenue'] }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                @foreach($report['categories'] as $name => $categoryInfo)
                    <tr>
                        <td>{{ $name }}</td>
                        <td>{{ $categoryInfo['products_count'] }}</td>
                        <td>{{ $categoryInfo['revenueAvg'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
